...
def addEthPrice():
    inputCsv="/mnt/sde1/geth/nft_analyse_v1/data/buySell/csv/buysell.csv"
    outputCsv="/mnt/sde1/geth/nft_analyse_v1/data/buySell/csv/buysell_withPrice.csv"
...
def addRevenue():
    inputCsv="/mnt/sde1/geth/nft_analyse_v1/data/buySell/csv/buysell_withPrice.csv"
    outputCsv="/mnt/sde1/geth/nft_analyse_v1/data/buySell/csv/buysell_withRevenue.csv"
    wethAddress="0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2"
...
def addMarket():
    ...
    inputCsv="/mnt/sde1/geth/nft_analyse_v1/data/buySell/csv/buysell_withRevenue.csv"
    outputCsv="/mnt/sde1/geth/nft_analyse_v1/data/buySell/csv/buysell_withMarket.csv"
...
def simplyMarketString(oldStr):
    ...
    if len(oldList)==1:
        return oldStr.split("_")[0]
    
    str0=oldList[0].split("_")[0]
    str1=oldList[1].split("_")[0]
    
    return str0

def dealMarket():    
    inputCsv="/mnt/sde1/geth/nft_analyse_v1/data/buySell/csv/buysell_withMarket.csv"
    outputCsv="/mnt/sde1/geth/nft_analyse_v1/data/buySell/csv/buysell_final.csv"
    ...
    with open(inputCsv,'r', encoding="UTF8") as fOld:
        ...
        for row in reader:
            ...
            row.append(simplyMarketString(row[-1]))
