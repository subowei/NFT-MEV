...
def getFromInternal(nftMap,etherTransferMap,txMap):
    ...
    for file in files:
        ...
        while (oneLine!=""):
            ...
            if transactionHash=="0x2dd9adee10f54e7ece5b7aa48ab946fc2e238d1d07fb310dbc0da90d40d69aa1":
                print(oneArray)
...
def getFromERC20(nftMap,etherTransferMap,txMap):
...
def getEthTransfer():
    ...
    etherTransferMap={}
    getFromInternal(nftMap,etherTransferMap,txMap)
    getFromERC20(nftMap,etherTransferMap,txMap)
